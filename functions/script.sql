...
-- -----------------------------------------------------
CREATE TABLE
    IF NOT EXISTS ClassicModels.Offices (
...
-- -----------------------------------------------------
CREATE TABLE
    IF NOT EXISTS ClassicModels.Employees (
        ...
        CONSTRAINT fk_Employees_Employees FOREIGN KEY (reportsTo) REFERENCES ClassicModels.Employees (employeeNumber) ON DELETE NO ACTION ON UPDATE NO ACTION,
        CONSTRAINT fk_Employees_Offices FOREIGN KEY (officeCode) REFERENCES ClassicModels.Offices (officeCode) ON DELETE NO ACTION ON UPDATE NO ACTION
    );

CREATE INDEX IF NOT EXISTS fk_Employees_Employees_idx ON ClassicModels.Employees (reportsTo ASC);

CREATE INDEX IF NOT EXISTS fk_Employees_Offices_idx ON ClassicModels.Employees (officeCode ASC);

-- -----------------------------------------------------
-- Table {schema}.{table} ClassicModels.Customers
-- -----------------------------------------------------
CREATE TABLE
    IF NOT EXISTS ClassicModels.Customers (
        ...
        creditLimit NUMERIC,
        CONSTRAINT fk_fk_Customers_Employees FOREIGN KEY (salesRepEmployeeNumber) REFERENCES ClassicModels.Employees (employeeNumber) ON DELETE NO ACTION ON UPDATE NO ACTION
    );

CREATE INDEX IF NOT EXISTS fk_Customers_Employees_idx ON ClassicModels.Customers (salesRepEmployeeNumber ASC);

-- -----------------------------------------------------
-- Table {schema}.{table} ClassicModels.ProductLines
-- -----------------------------------------------------
CREATE TABLE
    IF NOT EXISTS ClassicModels.ProductLines (
...
-- -----------------------------------------------------
CREATE TABLE
    IF NOT EXISTS ClassicModels.Products (
        ...
        CONSTRAINT fk_Products_ProductLines FOREIGN KEY (productLine) REFERENCES ClassicModels.ProductLines (productLine) ON DELETE NO ACTION ON UPDATE NO ACTION
    );

CREATE INDEX IF NOT EXISTS fk_Products_ProductLines_idx ON ClassicModels.Products (productLine ASC);

-- -----------------------------------------------------
-- Table {schema}.{table} ClassicModels.Orders
-- -----------------------------------------------------
CREATE TABLE
    IF NOT EXISTS ClassicModels.Orders (
        ...
        CONSTRAINT fk_Orders_Customers FOREIGN KEY (customerNumber) REFERENCES ClassicModels.Customers (customerNumber) ON DELETE NO ACTION ON UPDATE NO ACTION
    );

CREATE INDEX IF NOT EXISTS fk_Orders_Customers_idx ON ClassicModels.Orders (customerNumber ASC);

-- -----------------------------------------------------
-- Table {schema}.{table} ClassicModels.OrderDetails
-- -----------------------------------------------------
CREATE TABLE
    IF NOT EXISTS ClassicModels.OrderDetails (
        ...
        CONSTRAINT fk_OrderDetails_Products FOREIGN KEY (productCode) REFERENCES ClassicModels.Products (productCode) ON DELETE NO ACTION ON UPDATE NO ACTION,
        CONSTRAINT fk_OrderDetails_Orders FOREIGN KEY (orderNumber) REFERENCES ClassicModels.Orders (orderNumber) ON DELETE NO ACTION ON UPDATE NO ACTION
    );

CREATE INDEX IF NOT EXISTS fk_OrderDetails_Products_idx ON ClassicModels.OrderDetails (productCode ASC);

CREATE INDEX IF NOT EXISTS fk_OrderDetails_Orders_idx ON ClassicModels.OrderDetails (orderNumber ASC);

-- -----------------------------------------------------
-- Table {schema}.{table} ClassicModels.Payments
-- -----------------------------------------------------
CREATE TABLE
    IF NOT EXISTS ClassicModels.Payments (
        checkNumber VARCHAR(50) PRIMARY KEY,
        paymentDate TIMESTAMP NOT NULL,
        amount NUMERIC NOT NULL,
        customerNumber INTEGER NOT NULL,
        CONSTRAINT fk_Payments_Customers FOREIGN KEY (customerNumber) REFERENCES ClassicModels.Customers (customerNumber) ON DELETE NO ACTION ON UPDATE NO ACTION
    );

CREATE INDEX IF NOT EXISTS fk_Payments_Customers_idx ON ClassicModels.Payments (customerNumber ASC);
...
VALUES
    (
        ...
        '1:18',
        'Welly Diecast Productions',
        '1:18 scale die-cast about 10 inches long doors open, hood opens, trunk opens and wheels roll',
        '6906',
        '89.14',
        '151.08'
    );
...
VALUES
    (
        ...
        '1:12',
        'Exoto Designs',
        '1:12 scale die-cast about 20 inches long Hood opens, Rubber wheels',
        '6125',
        '55.7',
        '118.5'
    );
...
VALUES
    (
        ...
        '1:24',
        'Highway 66 Mini Classics',
        '1:24 scale die-cast about 18 inches long doors open, hood opens and rubber wheels',
        '4074',
        '32.37',
        '57.8'
    );
...
VALUES
    (
        'S32_1268',
        '1980s GM Manhattan Express',
        'Trucks and Buses',
        '1:32',
        'Motor City Art Classics',
        'This 1980s era new look Manhattan express is still active, running from the Bronx to mid-town Manhattan. Has 35 opeining windows and working lights. Needs a battery.',
        '5099',
        '53.93',
        '96.31'
    );
...
VALUES
    (
        ...
        '1:700',
        'Red Start Diecast',
        'All wood with canvas sails. Measures 31 1/2 inches Length x 22 3/8 inches High x 8 1/4 inches Width. Extras include 4 boats on deck, sea sprite on bow, anchors, copper railing, pilot houses, etc.',
        '7083',
        '33.97',
        '72.28'
    );
...
VALUES
    (
        ...
        '1:18',
        'Carousel DieCast Legends',
        'Features include opening and closing doors. Color: White. \r\nMeasures approximately 9 1/2 inches Long.',
        '6934',
        '46.53',
        '101.15'
    );
...
VALUES
    (
        ...
        '1:72',
        'Motor City Art Classics',
        '10 inches Wingspan with retractable landing gears.Comes with pilot',
        '551',
        '54.4',
        '80'
    );
...
VALUES
    (
        ...
        '2003-03-29 00:00:00',
        'Shipped',
        'Customer requested that ad materials (such as posters, pamphlets) be included in the shipment',
        '144'
    );
...
VALUES
    (
        ...
        '2003-06-06 00:00:00',
        'Shipped',
        'Customer requested special shipment. The instructions were passed along to the warehouse',
        '151'
    );
...
VALUES
    (
        ...
        '2003-11-09 00:00:00',
        'Shipped',
        'Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shipments of Porches',
        '278'
    );
...
-- ------------------------------------------------------------
INSERT INTO
    ClassicModels.Payments (customerNumber, checkNumber, paymentDate, amount)
VALUES
    (
        '103',
        'HQ336336',
